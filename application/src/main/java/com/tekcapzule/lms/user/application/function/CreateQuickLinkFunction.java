...
@Component
@Slf4j
public class CreateQuickLinkFunction implements Function<Message<CreateQuickLinkInput>, Message<List<QuickLink>>> {

    private final UserService userService;

    private final AppConfig appConfig;

    public CreateQuickLinkFunction(final UserService userService, final AppConfig appConfig) {
    ...
    public Message<List<QuickLink>> apply(Message<CreateQuickLinkInput> createQuickLinkInputMessage) {
        ...
        try {
            ...
            quickLinks = userService.createQuickLink(createQuickLinkCommand);
